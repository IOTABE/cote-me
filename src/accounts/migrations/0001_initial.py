    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aceitou_termos_em', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cnpj', models.CharField(blank=True, default='', help_text='Opcional', max_length=18)),
        ...
        migrations.CreateModel(
            name='Fornecedor',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='fornecedor_profile', serialize=False, to=settings.AUTH_USER_MODEL)),
                ...
                ('criado_em', models.DateTimeField(auto_now_add=True)),
                ('primeiro_acesso', models.DateTimeField(blank=True, null=True)),
            ],
            options={
